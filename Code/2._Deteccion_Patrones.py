...
datos = open("base/Terms_selected.csv" , "r", encoding='utf-8')
...
datos = open("base/Terms_selected_filtrado.csv" , "r", encoding='utf-8')
linea=datos.readline(); columna = linea.split(";")
while(True):
    linea=datos.readline(); columna = linea.split(";")
    if columna[0]==(""): break
...
datos = open("registros/ontologiasIOT.csv" , "r", encoding='utf-8')
linea=datos.readline(); columna = linea.split(";")
while(True):
    linea=datos.readline(); columna = linea.split(";")
    if columna[0]==(""): break
...
##REGISTRO DE TIPOS
result = open ("registros/Result.csv", 'w', encoding='utf-8'); result.truncate();
result.write("Vocabulario;Estructuras detectadas;\n")
resultad = open ("registros/Tipos.txt", 'w', encoding='utf-8'); resultad.truncate();
resultados = open ("registros/Original.txt", 'w', encoding='utf-8'); resultad.truncate();
...
repeticiones={}
contador=1
datos = open("registros/Tipos.txt" , "r", encoding='utf-8')
...
resultados = open("registros/Patrones.txt" , "w", encoding='utf-8')
print(len(patrones))
